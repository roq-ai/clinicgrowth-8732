...
type ColumnType = ColumnDef<WorkflowInterface, unknown>;
...
export function WorkflowListPage(props: WorkflowListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<WorkflowInterface>>(
    () => `/workflows?params=${JSON.stringify(params)}`,
    fetcher,
  );
