...
import { getWorkflows } from 'apiSdk/workflows';
...
import { PipelineListPage as ShowCaseList } from 'pages/pipelines';
...
function DashboardPage() {
  ...
  const workflowStat = useSWR<PaginatedInterface<WorkflowInterface>>(
    () => `/workflows`,
    () => getWorkflows({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Workflows',
      result: workflowStat?.data?.totalCount,
      isLoading: workflowStat.isLoading,
    },
    {
      title: 'Leads',
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`pipelines`} passHref legacyBehavior>
                  <Button
